...
Contributions réparties sur plusieurs lots :
    ...
    **Physique des rebonds** — réflexion vectorielle (mur vertical, mur incliné, coin) et **étude probabiliste des trajectoires** (marche aléatoire : espérance nulle, variance E[|pₙ|²] = n, comportement diffusif) — lot C.
    **Passage en 3D** — vector.h / vector.c et adaptation du code existant (lot E).
    **Théorie des graphes** — modélisation du réseau d'interactions entre particules (degré moyen, modèle d'Erdős–Rényi, rayon critique de connexité) — lot I.
